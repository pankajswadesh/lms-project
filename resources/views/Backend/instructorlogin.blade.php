...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="@if(isset($_GET['next'])) {{route('login_instructor',['next'=>$_GET['next']])}} @else {{route('login_instructor')}} @endif" method="post" autocomplete="off">
            {{csrf_field()}}
        ...
        <a href="{{route('forgot')}}">I forgot my password</a><br>
            ...
            <div class="google-btn-div">
                <a id="load-button-google" href="{{url('/google/redirect')}}" class="btn login-btn-inner-1 " style="display: block">
                ...
                <a id="load-button" href="{{ url('auth/github') }}" class="btn login-btn-inner-2 " style="display: block">
                    <div class=" btn-black-bg" >
                        <img src="{{url('/')}}/uploads/profilePhoto/github.png" class="login-inner-img">
                        <p class="google-btn-div-p2"><b>Log in with GitHub</b></p>
                    </div>
                </a>
            </div>

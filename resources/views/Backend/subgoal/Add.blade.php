<form id="validation2" action="{{route("savesubGoal",['id'=>$id])}}" class="form-horizontal" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
    ...
    <div class="modal-body clearfix">
        ...
        <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea type="text" name="description" class="validate[required] form-control" cols="4" rows="4"></textarea>
                </div>
            </div>
